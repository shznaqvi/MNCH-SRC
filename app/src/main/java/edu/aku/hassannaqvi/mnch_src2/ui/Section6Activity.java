...
// ============= Q 6.01 Skip Pattern =================
    ...
    private void SaveDraft() throws JSONException {
        ...
        s6.put("mn060202", mn060202.isChecked() ? "2" : "0");
        s6.put("mn060203", mn060203.isChecked() ? "3" : "0");
        s6.put("mn060204", mn060204.isChecked() ? "4" : "0");
        s6.put("mn060288", mn060288.isChecked() ? "88" : "0");
        s6.put("mn060288x", mn060288x.getText().toString());

        // Checkbox
        s6.put("mn060301", mn060301.isChecked() ? "1" : "0");
        s6.put("mn060302", mn060302.isChecked() ? "2" : "0");
        s6.put("mn060303", mn060303.isChecked() ? "3" : "0");
        s6.put("mn060304", mn060304.isChecked() ? "4" : "0");
        s6.put("mn060305", mn060305.isChecked() ? "5" : "0");
        s6.put("mn060388", mn060388.isChecked() ? "88" : "0");
    ...
    private boolean formValidation() {
        ...
        if (mn0601.getCheckedRadioButtonId() == -1) {
            ...
            mn060102.requestFocus();
            mn060102.setFocusable(true);
            mn060102.setFocusableInTouchMode(true);
...
// ========= Q 6.03 Skip check============
            ...
            if (mn060305.isChecked()) {
                ...
                if (mn0604.getCheckedRadioButtonId() == -1) {
                    ...
                    mn060488.requestFocus();
                    mn060488.setFocusableInTouchMode(true);
                    mn060488.setFocusable(true);
                    return false;
                } else {
            ...
            if (mn0605.getCheckedRadioButtonId() == -1) {
                ...
                mn060502.requestFocus();
                mn060502.setFocusable(true);
                mn060502.setFocusableInTouchMode(true);
