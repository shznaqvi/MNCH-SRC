...
public class SyncSec7Im extends AsyncTask<Void, Void, String> {
    ...
    protected String doInBackground(Void... params) {
        try {
            return downloadUrl(SRCApp._HOST_URL + "/src2/api/sec7im.php");
        } catch (IOException e) {
...
//            pd.setMessage("Total Forms: " );
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            Toast.makeText(mContext, sSynced + " Sec 7 IM's synced." + String.valueOf(json.length() - sSynced) + " Errors: " + sSyncedError, Toast.LENGTH_SHORT).show();

            pd.setMessage(sSynced + " Sec 7 IM's synced." + String.valueOf(json.length() - sSynced) + " Errors: " + sSyncedError);
            pd.setTitle("Done uploading Sec 7 IM's data");
            pd.show();
        } catch (JSONException e) {
            e.printStackTrace();
            ...
            pd.setTitle("Sec 7Im Sync Failed");
            pd.show();
        }
