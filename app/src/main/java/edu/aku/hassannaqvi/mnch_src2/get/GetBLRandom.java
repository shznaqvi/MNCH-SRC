package edu.aku.hassannaqvi.mnch_src2.get;
...
public class GetBLRandom extends AsyncTask<String, String, String> {

    private final String TAG = "GetBL_Random()";
    ...
    protected String doInBackground(String... args) {
        ...
        URL url = null;
        try {
            url = new URL(SRCApp._HOST_URL + "src2/api/" + singleRandom._URIGET);
