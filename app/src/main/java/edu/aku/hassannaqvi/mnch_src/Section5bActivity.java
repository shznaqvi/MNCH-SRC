...
public class Section5bActivity extends Activity {
    ...
    RadioGroup mn0531;
    @BindView(R.id.mn0531_1)
    RadioButton mn05311;
    @BindView(R.id.mn0531_2)
    RadioButton mn05312;
    ...
    RadioGroup mn0535;
    @BindView(R.id.mn0535_1)
    RadioButton mn05351;
    @BindView(R.id.mn0535_2)
    RadioButton mn05352;
    ...
    RadioGroup mn0537;
    @BindView(R.id.mn0537_1)
    RadioButton mn05371;
    @BindView(R.id.mn0537_2)
    RadioButton mn05372;
    ...
    RadioGroup mn0540;
    @BindView(R.id.mn0540_1)
    RadioButton mn05401;
    @BindView(R.id.mn0540_2)
    RadioButton mn05402;
    @BindView(R.id.mn0541)
    RadioGroup mn0541;
    @BindView(R.id.mn0541_1)
    RadioButton mn05411;
    @BindView(R.id.mn0541_2)
    RadioButton mn05412;
