 ...
 */
public class SyncSec4b extends AsyncTask<Void, Void, String> {
//
//    private static final String TAG = "SyncSec4b";
//    private Context mContext;
//    private ProgressDialog pd;
//
//
//    public SyncSec4b(Context context) {
//        mContext = context;
//    }
//
...
//        pd.setTitle("Please wait... Processing Sec4b");
//        pd.show();
//
//    }
//
...
//        try {
//            return downloadUrl(SRCApp._HOST_URL + "/src/api/sec4b.php");
//        } catch (IOException e) {
...
//    }
    ...
    protected String doInBackground(Void... params) {
        try {
            String url = SRCApp._HOST_URL + Sec4bContract.Section4bEntry._URL;
    ...
    private String downloadUrl(String myurl) throws IOException {
        ...
        //int len = 500;
        SRCDBHelper db = new SRCDBHelper(mContext);
        Collection<Sec4bContract> forms = db.getUnsyncedSec4b();
